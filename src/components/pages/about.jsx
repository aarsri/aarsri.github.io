...
const About = () => {
	return (
		<>
			...
			<Text>
				I'm a fifth-year Ph.D. candidate in
			...
			<ul>
				...
				<li>Aarohi Srivastava and David Chiang. “BERTwich: extending BERT's capabilities to model dialectal and noisy text.” In <i>Findings of the Association for Computational Linguistics: EMNLP</i> (2023). <Url link="https://aclanthology.org/2023.findings-emnlp.1037/" external={true}>Available here</Url>.</li><br />
				...
				<li>Aarohi Srivastava, Abhinav Rastogi, Abhishek Rao, Abu Awal Md Shoeb, Abubakar Abid, Adam Fisch, and others (in alphabetical order). “Beyond the Imitation Game: Quantifying and Extrapolating the Capabilities of Language Models.” In <i>Transactions on Machine Learning Research</i> (2023). <Url link="https://openreview.net/pdf?id=uyTL5Bvosj" external={true}>Available here</Url>. <PublicationLabel icon='fa-solid fa-trophy' title='Outstanding Paper Finalist'/></li><br />
				...
				<li>Aarohi Srivastava. “Doxastic Feel Like (That).” In <i>Yale Working Papers in Grammatical Diversity</i> (2020). <Url link="https://elischolar.library.yale.edu/ygdp/4/" external={true}>Available here</Url>.</li>
			</ul>
		</>
	);
}
